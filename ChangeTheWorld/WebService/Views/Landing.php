...
<body>
    ...
    <nav class="navbar navbar-expand-md fixed-top">
        <div class="container">
            <!-- Brand -->
            <a class="navbar-brand" href="Landing.html"><img src="IMG/LogoB.png" class="logito" alt="Logo" style="width:200px;"></a>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-7">
                    <div class="home-text">
                        ...
                        <div class="sign-up-btn">
                            <a href="userController.php?action=login" class="btn btn-1">Sign up</a>
                ...
                <div class="col-md-5 text-center">
                    <div class="home-img">
                        <img src="IMG/Landing/OnlineLearning.svg" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="owl-carousel comments-carousel">
                    <div class="comments-item">
                        <div class="img-box">
                            <img src="IMG/Landing/eljefe.jfif" alt="User Photo">
                    ...
                    <div class="comments-item">
                        <div class="img-box">
                            <img src="IMG/Landing/eldonas.jfif" alt="User Photo">
                            <i class="fas fa-comments"></i>
                        </div>
                    ...
                    <div class="comments-item">
                        <div class="img-box">
                            <img src="IMG/Landing/becerron.jfif" alt="User Photo">
                            <i class="fas fa-comments"></i>
                        </div>
                    ...
                    <div class="comments-item">
                        <div class="img-box">
                            <img src="IMG/Landing/larome.jfif" alt="User Photo">
                            <i class="fas fa-comments"></i>
                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="owl-carousel team-carousel">
                    <div class="team-item">
                        <img src="IMG/Yo.jpg" alt="Alberto Daniel Hernandez Villanueva">
                        <h3>Alberto Daniel Hernandez Villanueva</h3>
                        <span>Frontend/Backend</span>
                    </div>
                    <div class="team-item">
                        <img src="IMG/Landing/front.jfif" alt="Luis Gerardo Becerra Jiménez">
   ...
   <footer class="footer" data-scroll-index="4">
    ...
    <script>
        // gsap.from(".logito",{    duration:2,
        //     x:-200,
        //     });

        // gsap.from(".moradito",{duration:10, rotate:360})
    </script>
</body>
</html>