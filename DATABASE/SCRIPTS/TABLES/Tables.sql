...
CREATE TABLE IF NOT EXISTS tbl_Categories (
  ...
  PRIMARY KEY(id_categorie) 												COMMENT'This field represents pk of the table categories'
);
...
PRIMARY KEY(id_user) 											COMMENT'This field represents pk of the table users'
);
...
PRIMARY KEY(id_school)													COMMENT'This field represents pk of the table categories',
FOREIGN KEY(fk_user) REFERENCES tbl_Users(id_user))						COMMENT'This field represents fk of the table schools';
...
message 					TEXT 					NOT NULL 			COMMENT'This field represents the content of the comment .',
comment_date				DATE 					NOT NULL			COMMENT'This field represents the date of comments',				
PRIMARY KEY(id_comment_coments_course),
FOREIGN KEY(fk_comment) REFERENCES tbl_Comments_Courses(id_comment_course)
);
...
FOREIGN KEY(fk_comment) REFERENCES tbl_Comments_videos(id_comment_video)
);
