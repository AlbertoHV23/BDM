  ...
  <div class="container">
      ...
      <div class="signin-signup">
        <form action="#" class="sign-in-form">
          ...
          <div class="input-field">
            ...
            <input type="text" placeholder="Email or Username" id="log_username" name="username" />
          </div>
          <div class="input-field">
            <i class="fas fa-lock"></i>
            <input type="password" placeholder="Password" id="log_password" name="password"/>
          </div>
    ...
    <div class="panels-container">
      <div class="panel left-panel">
        ...
        <img src="IMG/Login/logiin.svg" class="image" alt="" />
      </div>
      <div class="panel right-panel">
        ...
        <img src="IMG/Login/verificar.svg" class="image" alt="" />
      </div>
    </div>
  </div>
