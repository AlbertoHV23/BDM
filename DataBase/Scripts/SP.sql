...
IN _action INT)
BEGIN
	IF _action = 1 THEN INSERT INTO tbl_users(role_user,photo,username,name_user,last_name,description_user,email,password_user,registered_date,date_of_last_change) VALUES(_role,photo,username,_name,_last,des,email,pass,regis_date,last_date);
